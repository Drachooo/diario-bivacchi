...
\usepackage[colorlinks=true, allcolors=blue,
            ...
            pdftitle={Casera Pian della Cenere},
...
\title{\textbf{Casera Pian della Cenere - 1012 metri s.l.m}}
\author{Matteo Drago}
...
\fancyfoot[C]{\small\itshape Casera Pian della Cenere}
...
\includegraphics[width=\linewidth,height=8cm,keepaspectratio, frame]{images/bivacco.jpg}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.5\textwidth}
  ...
  \\[1em] % Aggiunge una riga vuota qui
  Coordinate\\  
  \textbf{\large \href{https://maps.google.com/?q=45.72783,10.88464}{45.72783° N, 10.88464° E}}
  \\[1em] % Aggiunge una riga vuota qui
  Apertura\\  
...
Posti letto effettivi & Assenti \\
Presenze in visita & 15 persone \\
Arredi & Tavolo, panche, camino \\
Acqua & \ding{55} - Abbeveratorio esterno\\
Servizi igienici & \ding{55} \\
Copertura telefonica & \ding{55} - Poca in alcuni punti \\
Manutenzione / proprietà & Pubblico / CAI / Comune \\
Visitato il & 9-10 dicembre 2023 e 17-18 febbraio 2024\\
\hline
\end{tabularx}
